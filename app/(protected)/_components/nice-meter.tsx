...
export const NiceMeter = ({ user, label }: NiceMeterProps) => {
  return (
    <Card className='flex flex-col w-[55%] m-4 bg-santa-red text-2xl text-white'>
      ...
      <CardContent className={cn(`flex flex-row ${style.meterContainer}`)}>
        ...
        <Image src='/newNNmeter.png' alt='naughty nice meter' width='350' height='10'/>
        </div>
        ...
        <Button variant={"green"}><PiSpeedometer className="mr-2" /> Details</Button>
        </div>
